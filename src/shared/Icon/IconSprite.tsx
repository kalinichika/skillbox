...
export function IconSprite() {
  return (
    ...
    >
      ...
      <symbol id="block" viewBox="0 0 426.667 426.667">
        <path
      ...
      <symbol id="bookmark" viewBox="0 0 512 512">
        <path
          d="M416.667,0H95.334c-8.284,0-15,6.716-15,15v482c0,6.067,3.655,11.536,9.26,13.858c1.856,0.769,3.805,1.142,5.737,1.142
          c3.903,0,7.74-1.523,10.609-4.394l150.063-150.062L406.06,507.606c4.29,4.291,10.741,5.573,16.347,3.252
          c5.605-2.322,9.26-7.791,9.26-13.858V15C431.667,6.716,424.952,0,416.667,0z"
        />
      </symbol>
      <symbol id="comments" x="0px" y="0px" viewBox="0 0 550 510">
      ...
      <symbol id="menu" viewBox="0 0 5 20">
        <circle cx="2.5" cy="2.5" r="2.5" />
        <circle cx="2.5" cy="10" r="2.5" />
        <circle cx="2.5" cy="17.5" r="2.5" />
      </symbol>
      <symbol id="save" viewBox="0 0 426.667 420">
        <path d="M42.667,85.333H0V384c0,23.573,19.093,42.667,42.667,42.667h298.667V384H42.667V85.333z" />
        <path d="M384,0H128c-23.573,0-42.667,19.093-42.667,42.667v256c0,23.573,19.093,42.667,42.667,42.667h256 c23.573,0,42.667-19.093,42.667-42.667v-256C426.667,19.093,407.573,0,384,0z M362.667,192h-85.333v85.333h-42.667V192h-85.333 v-42.667h85.333V64h42.667v85.333h85.333V192z" />
      </symbol>
      <symbol id="share" viewBox="4 2 22 22">
